...
export const AgentStateIdle: AgentState = "idle"; // no active turn; ready for next user message
export const AgentStateAwaitingInput: AgentState = "awaiting_input"; // turn paused; needs user (approval, mid-turn question)
export const AgentStateToolRunning: AgentState = "tool_running"; // turn active; tool currently executing or model generating
export const AgentStateError: AgentState = "error"; // last activity ended in error
/**
