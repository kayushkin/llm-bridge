...
//
// Generated from github.com/kayushkin/llm-bridge/msg @ dcd93685d1e1eafef0f1d5b7d73ac9eefc5e2139-dirty
 ...
 */
export interface FoldInactiveRequest {
 ...
 */
export interface FoldInactiveResponse {
  moved: number /* int */;
  folder: string;
  ids?: string[];
}
